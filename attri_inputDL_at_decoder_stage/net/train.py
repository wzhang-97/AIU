...
def goTrain():
  ...
  # checkpoint
  filepath=fpath+"test11/check11/fseg-{epoch:02d}.hdf5"
...
def showHistory(history):
  ...
  plt.show()
  plt.savefig('history for accuracy11.png')
  plt.close()
  ...
  plt.tick_params(axis='both', which='minor', labelsize=18)
  plt.show()
  plt.savefig('history for loss11.png')
  plt.close()

  with open('loss11.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['loss']))
  with open('val_loss11.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['val_loss']))

  with open('acc11.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['acc']))
  with open('val_acc11.txt','a',encoding='utf-8') as f:
