...
fpath = '/home/wenzhang/AttributesandUnet_testsforPaper/'
...
def goTrain():
  ...
  params = {'batch_size':1,#一次训练所选取的样本数
          ...
          'n_channels':1,
          'shuffle': True}
  # seismPath = fpath+"data_for_train/"
  seismPath = fpath+"data_for_train/histo_to_3/"  
  ...
  #model = unet(input_size1 = (None,None,None,1),input_size2 = (None,None,None,19),input_size3 = (None,None,None,19),input_size4 = (None,None,None,19))
  ...
  # checkpoint
  filepath=fpath+"test1/check1/fseg-{epoch:02d}.hdf5"
...
def showHistory(history):
  ...
  plt.show()
  plt.savefig('history for accuracy1.png')
  plt.close()
  ...
  plt.tick_params(axis='both', which='minor', labelsize=18)
  plt.show()
  plt.savefig('history for loss1.png')
  plt.close()

  with open('loss1.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['loss']))
  with open('val_loss1.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['val_loss']))

  with open('acc1.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['acc']))
  with open('val_acc1.txt','a',encoding='utf-8') as f:
