...
def unet(input_size1 = (128,128,128,1),input_size2 = (128,128,128,19),input_size3 = (128,128,128,19),input_size4 = (128,128,128,19),input_size5 = (128,128,128,19)):
    ...
    pool1 = concatenate([MaxPooling3D(pool_size=(2,2,2))(conv1),gx0],axis=-1)
    ...
    pool2 = concatenate([MaxPooling3D(pool_size=(2,2,2))(conv2),gx1],axis=-1)
    ...
    pool3 = concatenate([MaxPooling3D(pool_size=(2,2,2))(conv3),gx2],axis=-1)
    ...
    pool4 = concatenate([MaxPooling3D(pool_size=(2,2,2))(conv4),gx3],axis=-1)
