...
def showHistory(history):
  ...
  plt.show()
  plt.savefig('history for accuracy6.png')
  plt.close()
  ...
  plt.tick_params(axis='both', which='minor', labelsize=18)
  plt.show()
  plt.savefig('history for loss6.png')
  plt.close()

  with open('loss6.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['loss']))
  with open('val_loss6.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['val_loss']))

  with open('acc6.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['acc']))
  with open('val_acc6.txt','a',encoding='utf-8') as f:
