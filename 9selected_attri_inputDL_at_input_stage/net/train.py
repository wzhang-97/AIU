...
os.environ['CUDA_VISIBLE_DEVICES']='0'#训练的时候用这个GPU.
...
def showHistory(history):
  ...
  plt.show()
  plt.savefig('history for accuracy145.png')
  plt.close()
  ...
  plt.tick_params(axis='both', which='minor', labelsize=18)
  plt.show()
  plt.savefig('history for loss145.png')
  plt.close()

  with open('loss145.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['loss']))
  with open('val_loss145.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['val_loss']))

  with open('acc145.txt','a',encoding='utf-8') as f:
    f.write(str(history.history['acc']))
  with open('val_acc145.txt','a',encoding='utf-8') as f:
