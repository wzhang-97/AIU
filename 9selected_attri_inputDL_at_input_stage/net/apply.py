...
def loadModel():
  global model
  model = load_model(path+"../../../test145/check145/fseg-85.hdf5")
...
def goboxing(): 
  ...
  # fx = np.transpose(fx)
  # fx.tofile(path+"test145_boxing_18226.dat",format="%4")
  ...
  fx = np.transpose(fx)
  fx.tofile(path+"test145_boxing_z_2_subsampled_18226.dat",format="%4")
...
def godfb(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_dfb_cut.dat",format="%4")
...
def gohz08(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_hz08_cut.dat",format="%4")
...
def govolve(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_volve.dat",format="%4")
...
def gonew(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_new.dat",format="%4")
...
def gobgp_subsampled(): 
  ...
  fx = np.transpose(fx)
  fx.tofile(path+"test145_bgp_cut_z_2_subsampled_6223.dat",format="%4")
  ...
  fx = np.transpose(fx)
  fx.tofile(path+"test145_bgp_cut_z_4_subsampled_6223.dat",format="%4")
...
def gof3(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_f3d_cut.dat",format="%4")
...
def gobgp(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_bgp_cut6223.dat",format="%4")
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_bgp_cut18226.dat",format="%4")
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_bgp_cut24228.dat",format="%4")
...
def gokerry(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_kerry_cut.dat",format="%4")
...
def gofakedata(): 
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_fake385.dat",format="%4")
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_fake390.dat",format="%4")
  ...
  fx = goPredictSubs(m1,m2,m3,gm) #make a prediction 
  fx = np.transpose(fx)
  fx.tofile(path+"test145_fake395.dat",format="%4")
